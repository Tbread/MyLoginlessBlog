...
import com.tbread.myloginlessblog.Dto.DubChkRequestDto;
import com.tbread.myloginlessblog.Dto.SignupRequestDto;
import com.tbread.myloginlessblog.models.User;
import com.tbread.myloginlessblog.models.UserRole;
import com.tbread.myloginlessblog.repository.UserRepository;
import com.tbread.myloginlessblog.security.UserDetailsImpl;
import com.tbread.myloginlessblog.security.kakao.KakaoOAuth2;
import com.tbread.myloginlessblog.security.kakao.KaKaoUserInfo;
...
public class UserService {
    ...
    public Boolean dubChk(DubChkRequestDto requestDto) {
        String username = requestDto.getUsername();
        Optional<User> found = userRepository.findByUsername(username);
        if (found.isPresent()) {
